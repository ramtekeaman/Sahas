...
export default function Addp({dbpath, qrid}) {
...
navigate("/UpdateP");
  ...
  return (
    ...
    <div style={{backgroundColor:'#f1ebff'}}>
      ...
      <center>
          <h1 className="sp1" style={{fontWeight:'700', color:'rgb(67,35,130)'}}>Add Product</h1>
        </center>
        <br />
        ...
        <form>
          <div className="mb-3">
            <label className="form-label" style={{color:'RGB(104 81 155)'}}>Product ID</label>
            {Fid.map((res) =>
              <input type="number" className="form-control" id="trno" value={res.id} disabled />
            )}
          </div>
          <div className="mb-3">
            <label className="form-label" style={{color:'RGB(104 81 155)'}}>Product Name</label>
          ...
          <div className="mb-3">
            <label className="form-label" style={{color:'RGB(104 81 155)'}}>Product Price<span style={{color:'red'}}>*</span></label>
